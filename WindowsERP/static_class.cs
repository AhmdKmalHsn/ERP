    ...
    public static class static_class
    {
        ...
        static public DataSet getbysql(string sql)
        {
            ...
            try
            {
                ...
                var c = new SqlConnection(Properties.Settings.Default.Properties["CS"].ToString()); // Your Connection String here
        ...
        static public DataSet insertbysql(string sql)
        {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(Properties.Settings.Default.Properties["CS"].ToString()))
                {
                    con.Open();
                    com.Connection = con;
